...
{
public:
    Order(OrderType orderType, OrderId orderId, Side side, Price price, Quantity quantity, int contract)
    ...
    Order(OrderId orderId, Side side, Quantity quantity)
        : Order(OrderType::Market, orderId, side, Constants::InvalidPrice, quantity, 1)
    { }
